...
# except:
#     usage()
input_dir = "/Users/damianfernandez/Desktop/gamma"
...
dict_figuras = {}
dict_figuras[("policies_single_savings", "Savings %")] = policies_single_savings
dict_figuras[("policies_multi_savings", "Savings %")] = policies_multi_savings
...
dict_figuras[("policies_single_kw", "kWh/shutting")] = policies_single_kw
dict_figuras[("policies_multi_kw", "kWh/shutting")] = policies_multi_kw
...
dict_figuras[("policies_single_service_90p_first", "Queue time (s)")] = policies_single_service_90p_first
dict_figuras[("policies_multi_service_90p_first", "Queue time (s)")] = policies_multi_service_90p_first
dict_figuras[("policies_single_service_90p_fully", "Queue time (s)")] = policies_single_service_90p_fully
dict_figuras[("policies_multi_service_90p_fully", "Queue time (s)")] = policies_multi_service_90p_fully
...
for key, value in dict_figuras.iteritems():
    ...
    ax.set_xlabel('Lost resources factor')
    ax.set_ylabel('Distribution threshold')
    ax.set_zlabel(key[1])
